...
class Triangle extends Shapes {
    ...
    render() {
        ...
        <text x="50" y="25" font-size="20" text-anchor="middle" fill="WHITE">${this.text}</text>
        <polygon points="100,0 0,200 200,200" fill="${this.color}"/>
        </svg>`;
    }
}
...
class Circle extends Shapes {
    ...
    render() {
        ...
        <text x="50" y="25" font-size="20" text-anchor="middle" fill="${this.color}">${this.text}</text>
